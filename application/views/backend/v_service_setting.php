...
<body class="page-header-fixed  compact-menu  pace-done page-sidebar-fixed">
    ...
    <main class="page-content content-wrap">
        ...
        <div class="page-inner">
            ...
            <div id="main-wrapper">
                <div class="row">
                    <form class="form-horizontal" action="<?php echo base_url() . 'backend/service_setting/update' ?>" method="post" enctype="multipart/form-data">
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="service_title" class="form-control" id="input1" value="<?= $service_title; ?>" placeholder="Site Title">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="input1" class="col-sm-2 control-label">Subtitle</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="service_subtitle" class="form-control" id="input1" value="<?= $service_subtitle; ?>" placeholder="Site Title">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="input1" class="col-sm-2 control-label">Service 1</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="service_service1" class="form-control" id="input1" value="<?= $service_service1; ?>" placeholder="Site Title">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="input1" class="col-sm-2 control-label">Deskripsi 1</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="service_description1" class="form-control" id="input1" value="<?= $service_description1; ?>" placeholder="Site Title">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="input1" class="col-sm-2 control-label">Service 2</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="service_service2" class="form-control" id="input1" value="<?= $service_service2; ?>" placeholder="Site Title">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="input1" class="col-sm-2 control-label">Deskripsi 2</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="service_description2" class="form-control" id="input1" value="<?= $service_description2; ?>" placeholder="Site Title">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="input1" class="col-sm-2 control-label">Service 3</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="service_service3" class="form-control" id="input1" value="<?= $service_service3; ?>" placeholder="Site Title">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="input1" class="col-sm-2 control-label">Deskripsi 3</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="service_description3" class="form-control" id="input1" value="<?= $service_description3; ?>" placeholder="Site Title">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="input1" class="col-sm-2 control-label">Service 4</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="service_service4" class="form-control" id="input1" value="<?= $service_service4; ?>" placeholder="Site Title">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="input1" class="col-sm-2 control-label">Deskripsi 4</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="service_description4" class="form-control" id="input1" value="<?= $service_description4; ?>" placeholder="Site Title">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="input1" class="col-sm-2 control-label">Service 5</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="service_service5" class="form-control" id="input1" value="<?= $service_service5; ?>" placeholder="Site Title">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="input1" class="col-sm-2 control-label">Deskripsi 5</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="service_description5" class="form-control" id="input1" value="<?= $service_description5; ?>" placeholder="Site Title">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="input1" class="col-sm-2 control-label">Service 6</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="service_service6" class="form-control" id="input1" value="<?= $service_service6; ?>" placeholder="Site Title">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="input1" class="col-sm-2 control-label">Deskripsi 6</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="service_description6" class="form-control" id="input1" value="<?= $service_description6; ?>" placeholder="Site Title">
                                        </div>
                                    </div>
    ...
    <?php if ($this->session->flashdata('msg') == 'success') : ?>
        <script type="text/javascript">
            $.toast({
                heading: 'Success',
                text: "Service Information Saved!",
