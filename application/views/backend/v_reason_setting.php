...
<body class="page-header-fixed  compact-menu  pace-done page-sidebar-fixed">
    ...
    <main class="page-content content-wrap">
        ...
        <div class="page-inner">
            ...
            <div id="main-wrapper">
                <div class="row">
                    <form class="form-horizontal" action="<?php echo base_url() . 'backend/reason_setting/update' ?>" method="post" enctype="multipart/form-data">
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="reason_title" class="form-control" id="input1" value="<?= $reason_title; ?>" placeholder="Site Title">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="input1" class="col-sm-2 control-label">Subtitle</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="reason_subtitle" class="form-control" id="input1" value="<?= $reason_subtitle; ?>" placeholder="Site Title">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="reason_how1" class="form-control" id="input1" value="<?= $reason_how1; ?>" placeholder="Site Title">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="reason_how2" class="form-control" id="input1" value="<?= $reason_how2; ?>" placeholder="Site Title">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="reason_how3" class="form-control" id="input1" value="<?= $reason_how3; ?>" placeholder="Site Title">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <input type="hidden" name="reason_id" value="<?php echo $reason_id ?>" required>
