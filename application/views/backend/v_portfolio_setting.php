...
<body class="page-header-fixed  compact-menu  pace-done page-sidebar-fixed">
    ...
    <main class="page-content content-wrap">
        ...
        <div class="page-inner">
            ...
            <div id="main-wrapper">
                <div class="row">
                    <form class="form-horizontal" action="<?php echo base_url() . 'backend/portfolio_setting/update' ?>" method="post" enctype="multipart/form-data">
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="title" class="form-control" id="input1" value="<?php echo $title; ?>" placeholder="Site Title">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="input1" class="col-sm-2 control-label">Subtitle</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="subtitle" class="form-control" id="input1" value="<?php echo $subtitle; ?>" placeholder="Site Subtitle">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label for="input1" class="col-sm-2 control-label">Project 1</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="project1" class="form-control" id="input1" value="<?php echo $project1; ?>" placeholder="Site Name">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="project2" class="form-control" id="input1" value="<?php echo $project2; ?>" placeholder="Site Name">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="project3" class="form-control" id="input1" value="<?php echo $project3; ?>" placeholder="Site Name">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <input type="hidden" name="portfolio_id" value="<?php echo $portfolio_id ?>" required>
    ...
    <?php if ($this->session->flashdata('msg') == 'success') : ?>
        <script type="text/javascript">
            $.toast({
                heading: 'Success',
                text: "Portfolio Information Saved!",
